  ...
  return knex('steps').truncate()
    .then(function () {
      ...
      return knex('steps').insert([
        ...
        {step_number: 1, description: 'Before buring add this', ingredient_id: 8, recipe_id: 2},
        ...
        {step_number: 1, description: 'Pound to a pulp', ingredient_id: 10, recipe_id: 3},
        ...
        {step_number: 3, description: 'Add even more of this', ingredient_id: 2, recipe_id: 4},
        {step_number: 1, description: 'Is this on the list, add it', ingredient_id: 3, recipe_id: 5},
        {step_number: 2, description: 'Swirl then dab', ingredient_id: 14, recipe_id: 5},
        {step_number: 3, description: 'Dabbing is a no no', ingredient_id: 5, recipe_id: 5}
      ]);
    });
};
